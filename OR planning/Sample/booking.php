...
if(isset($_REQUEST['l']))
{
	...
	$q="UPDATE `register` SET `slot`='$un' ,`start`= '$un1',`end`= '$un2' WHERE `id`='$y'";
...
<tr><td>User Id<td><td><?php echo $y?></td></tr>
<tr><td>Book a date<td><td><input type="date" name="p"></td></tr>
<tr><td>Start time <td><td><input type="time" name="st"></td></tr>
<tr><td>End time<td><td><input type="time" name="en"></td></tr>
