...
<table style="width:50%; height:20%; margin-left:25%; margin-top:3%;">
  <tr>
	...
	<tr><td align="center" >Patient Id</td> <td align="center" >Patient Name</td><td align="center" >Patient Type</td> <td align="center" >Type of surgery</td> <td align="center" >medical history</td> <td align="center"  > Department</td> <td align="center"  > Consultant name</td>   </tr>
  </tr>
  <?php
 $mn= $_SESSION['login_user'];
  $q3 = "SELECT * FROM register ";
	...
	?>    
		...
		<tr> <td><?php echo $q5[0]; ?></td> <td><?php echo $q5[2]; ?></td><td><?php echo $q5[15]; ?></td><td><?php echo $q5[16]; ?></td><td><?php echo $q5[17]; ?></td><td><?php echo $q5[13]; ?> </td> <td><?php echo $q5[14]; ?> </td></tr>
